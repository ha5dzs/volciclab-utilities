function [rigid_body_structure] = volciclab_optitrack_get_take(tak_file_path, csv_file_path)
...
%
% Input arguments are:
%   [NOTE]: Every file path must be absolute.
...
%optitrack_get_take('G:/Saját meghajtó/optitrack_sandbox/Matlab wrapper/input_files/rigid_body1.tak', 'G:/Saját meghajtó/optitrack_sandbox/Matlab wrapper/output_files/rigid_body1.csv')
    ...
    string_to_execute = sprintf('"%s" "%s" "%s"', converter_executable_location, tak_file_path, csv_file_path);
