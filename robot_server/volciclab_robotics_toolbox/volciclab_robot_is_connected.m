function robot_connected = volciclab_robot_is_connected(robot_config_struct)
...
%% Do the work.
    write(robot_config_struct.udp_object, 'Is the robot connected?', robot_config_struct.ip_address, robot_config_struct.port);
    % Wait for the reply
